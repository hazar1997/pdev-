	...
	LivraisonRepository lr;
       ...
       // http://localhost:8090/SpringMVC/livreur/modify-livreur
		...
		// http://localhost:8090/SpringMVC/livreur/retrieve-livreur/{livreur-id}
		   ...
		   // http://localhost:8090/SpringMVC/livreur/findByName/{email}
			   @GetMapping("/findLivreur/{nomLiv}")
			   @ResponseBody
			 public List<Livreur> findLivreur(@PathVariable ("nomLiv")String nomLiv) {
			        return livreurService.findByName(nomLiv);
			    }
		 ...
		 // http://localhost:8090/SpringMVC/livreur/sort-up
		    @GetMapping("/sort-up")
		    @ResponseBody
		    public List<Livreur> getList() {
		    List<Livreur> listlivreurs = livreurService.sortUp();
		    return listlivreurs;
		    }
